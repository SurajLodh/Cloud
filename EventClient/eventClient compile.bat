...
start "MVN INSTALLING jeventClient jar files maven repository .. " cmd.exe /k "mvn install:install-file -Dfile=C:\Cloud\EventClient\jevent.jar -DgroupId=myevent -DartifactId=jevent -Dversion=1.0 -Dpackaging=jar -DgeneratePom=true"
